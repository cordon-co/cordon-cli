...
- More detail can be found in `docs/cordon-technical-concepts.md`
...
3. Read `docs/cordon-technical-concepts.md` if you need to further understand a product concept
4. Update `docs/current-task.md` with a summary of the work you are about to perform, the key files involved, and the relevant requirement IDs
